...
$("#submit").click(function(event){
    ...
    window.location = 'mailto:devrpatel26@gmail.com?subject='+subject+'&body='+body;
});
...
function Timeline(cvs) {
    ...
    self.dotColors = [
        ...
        ['#3FB2FF', 'rgba(160, 217, 255, 0.3)', 'rgba(160, 217, 255, 0.2)'],
    ];
    ...
    function init() {
        ...
        try {
            ...
            self.lines[1] = new Line(0, canvas.offsetHeight - 100, '#3FB2FF', self.options, mouse);
